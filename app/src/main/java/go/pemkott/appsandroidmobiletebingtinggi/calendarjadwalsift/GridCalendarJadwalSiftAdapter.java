package go.pemkott.appsandroidmobiletebingtinggi.calendarjadwalsift;
...
public class GridCalendarJadwalSiftAdapter extends RecyclerView.Adapter<GridCalendarJadwalSiftAdapter.GridViewHolder> {
    ...
    String bulan, tahun;
    Context context;
    public GridCalendarJadwalSiftAdapter(Context context, ArrayList<JadwalSift> listJadwal, ArrayList<WaktuSift> waktuSifts, String bulan, String tahun) {

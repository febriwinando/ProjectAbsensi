package go.pemkott.appsandroidmobiletebingtinggi.jadwalsift;
...
import go.pemkott.appsandroidmobiletebingtinggi.jadwalsift.absensifting.AbsenSiftActivity;
...
//            String tanggalJadwalS = null, today;
//            today = SIMPLE_FORMAT_TANGGAL.format(new Date());
//            tanggalJadwalS = tanggalJadwal.get(position);
//            Date tglJadwal = null, tglToday =null;
//            try {
//                tglJadwal = SIMPLE_FORMAT_TANGGAL.parse(tanggalJadwalS);
//                tglToday = SIMPLE_FORMAT_TANGGAL.parse(today);
//            } catch (ParseException e) {
//                e.printStackTrace();
//            }

//            if (tglJadwal.getMonth() >= tglToday.getMonth()){
...
//            }
                        ...
                        if (tipesift.equals("malam")){
                            ...
                            if (jamSekarang.getTime()> batasJamAbsenMalam.getTime()){
                                ...
                                if (jam_masuk != null && jam_pulang != null){
                                    ...
                                    viewinfo(JadwalSiftActivity.this, s, inisialsift, tipesift, masuksift, pulangsift, idsift);
                                }
                            }
                        }
    ...
    public void viewinfo(Context context, String tanggal, String inisial, String sift, String masuk, String pulang, String idsift){
        ...
        txtAbsen.setOnClickListener(view -> {
            Intent absensift = new Intent(JadwalSiftActivity.this, AbsenSiftActivity.class);
            ...
            absensift.putExtra("tipesift", sift);
    ...
    public void unduhJadwalSift(int status){
        progressDialog = new ProgressDialog(JadwalSiftActivity.this, R.style.AppCompatAlertDialogStyle);
